          ...
          <Row >
            <Col class="border border-success">
              ...
              <div >
                ...
                <Row>
                  <Col class="border border-primary"> <Button variant="primary"  onClick={() => (isInsightful) ? handleUnInsightful() : handleInsightful()}>Insightful<Badge bg="secondary" >{videoData[index].votes.insightful.usernames.length}{(isInsightful)?'🤔':''}</Badge></Button></Col>
