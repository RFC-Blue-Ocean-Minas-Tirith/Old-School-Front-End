...
function LandingPage({ currentUser, videoData, setVideoData }) {
  ...
  useEffect(() => {
    if (videoData) {
      axios.get('http://ec2-3-16-44-36.us-east-2.compute.amazonaws.com:8080/user')
        .then(res => {
  ...
  const getThumbnails = () => {
    ...
    if (sortOn !== 'favorited') {
      axios.get(`http://ec2-3-16-44-36.us-east-2.compute.amazonaws.com:8080/video/${sortOn}`)
        .then(res => {
  ...
  const handleInsightful = () => {
    axios.put(`http://ec2-3-16-44-36.us-east-2.compute.amazonaws.com:8080/video/insightful`, { currentUser: currentUser, username: videoData[index].username, videoID: videoData[index]._id })
      .then(() => {
        getThumbnails();
      })
  ...
  const handleUnInsightful = () => {
    axios.put(`http://ec2-3-16-44-36.us-east-2.compute.amazonaws.com:8080/video/insightfulx`, { currentUser: currentUser, username: videoData[index].username, videoID: videoData[index]._id })
      .then(() => {
        getThumbnails();
      })
      .catch(err => console.log(err));
  ...
  const handleInformative = () => {
    axios.put(`http://ec2-3-16-44-36.us-east-2.compute.amazonaws.com:8080/video/informative`, { currentUser: currentUser, username: videoData[index].username, videoID: videoData[index]._id })
      .then(() => {
        getThumbnails();
        if (videoData[index].votes.informative.usernames.includes(currentUser)) {
          setInformative(true);
  ...
  const handleUnInformative = () => {
    axios.put(`http://ec2-3-16-44-36.us-east-2.compute.amazonaws.com:8080/video/informativex`, { currentUser: currentUser, username: videoData[index].username, videoID: videoData[index]._id })
      .then(() => {
        getThumbnails();
      })
      .catch(err => console.log(err));
  ...
  const handleFunny = () => {
    axios.put(`http://ec2-3-16-44-36.us-east-2.compute.amazonaws.com:8080/video/funny`, { currentUser: currentUser, username: videoData[index].username, videoID: videoData[index]._id })
      .then(() => {
        getThumbnails();
      })
      .catch(err => console.log(err));
  ...
  const handleUnFunny = () => {
    axios.put(`http://ec2-3-16-44-36.us-east-2.compute.amazonaws.com:8080/video/funnyx`, { currentUser: currentUser, username: videoData[index].username, videoID: videoData[index]._id })
      .then(() => {
        getThumbnails();
      })
      .catch(err => console.log(err));
  ...
  function handleFave() {
    return axios.put('http://ec2-3-16-44-36.us-east-2.compute.amazonaws.com:8080/video/userprofile', { currentUser: currentUser, user: videoData[index].username })
      .then((data) => {
        setIsFavorite(true);
      });
  }
  function handleUnFave() {
    return axios.put('http://ec2-3-16-44-36.us-east-2.compute.amazonaws.com:8080/video/userprofilex', { currentUser: currentUser, user: videoData[index].username })
      .then((data) => {
        setIsFavorite(false);
      });
  }
