...
function ProfilePage() {
  ...
  function fetchData() {
    ...
    .then((data) => {
      setUser(data.data)
      return axios.get(`http://ec2-52-14-88-68.us-east-2.compute.amazonaws.com:8080/video/user/${user}`)
    })
    .then((data) => {
      setVideos(data.data);
    })
    .then(() => {
      return axios.get(`http://ec2-52-14-88-68.us-east-2.compute.amazonaws.com:8080/blog/user/${user}`);
    })
    .then((data) => {
      setBlogs(data.data);
    });
