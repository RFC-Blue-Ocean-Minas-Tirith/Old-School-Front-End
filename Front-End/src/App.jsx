...
function App() {
  ...
  function handleAddUserToDB() {
    axios.post('http://ec2-3-16-44-36.us-east-2.compute.amazonaws.com:8080/user', currentUser);
  }

  useEffect(() => {
    axios.get('http://ec2-3-16-44-36.us-east-2.compute.amazonaws.com:8080/video')
      .then(res => {
